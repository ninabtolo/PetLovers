...
while (execucao) {
    ...
    switch (opcao) {
        ...
        case 6:
            ...
            break;
        case 7:
            let cadastroPet = new CadastroPet(empresa.getClientes[0]); // Exemplo: ajustado para um cliente específico
            cadastroPet.cadastrarPet();
            break;
        case 8:
            let listagemPets = new ListagemPets(empresa.getClientes[0].getPets); // Exemplo: ajustado para um cliente específico
            listagemPets.listar();
            break;
        ...
        case 14:
            ...
            break;
        case 15:
            let atualizarPet = new AtualizarPet(empresa.getClientes[0]); // Exemplo: ajustado para um cliente específico
            atualizarPet.atualizar();
            break;
        case 16:
            let excluirPet = new ExclusaoPet(empresa.getClientes[0]); // Exemplo: ajustado para um cliente específico
            excluirPet.deletar();
            break;
